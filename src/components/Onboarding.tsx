    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col items-center justify-center p-4">
      ...
      >
        <div className="flex flex-col items-center text-center mb-8">
          <div className="w-14 h-14 bg-indigo-500/10 rounded-2xl flex items-center justify-center text-indigo-650 dark:text-indigo-400 mb-4 border border-indigo-500/20">
            <Briefcase className="w-7 h-7" />
          </div>
          <h1 className="text-2xl font-extrabold text-slate-900 dark:text-white">Welcome to Freelancer CRM</h1>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full text-sm py-2.5 px-4 rounded-xl glass-input focus:outline-none focus:border-indigo-500 text-slate-800 dark:text-slate-202"
              />
            </div>
          </div>
            ...
            <div className="grid grid-cols-2 gap-3 text-sm">
              <div
                ...
                className={`cursor-pointer border p-3 rounded-2xl transition-all relative ${
                  selectedPlan === "Free"
                    ? "border-indigo-500 bg-indigo-500/10 dark:border-indigo-500"
                    : "border-black/5 dark:border-white/5 bg-black/5 hover:bg-black/10 text-slate-400"
                }`}
              >
                {selectedPlan === "Free" && (
                  <span className="absolute top-2 right-2 bg-slate-700 dark:bg-indigo-500 p-0.5 rounded-full text-white">
                    <Check size={10} />
                  </span>
                )}
              ...
              <div
                ...
                className={`cursor-pointer border p-3 rounded-2xl transition-all relative ${
                  selectedPlan === "Pro"
                    ? "border-violet-500 bg-violet-500/10 dark:border-violet-500"
                    : "border-black/5 dark:border-white/5 bg-black/5 hover:bg-black/10 text-slate-450"
                }`}
              >
                {selectedPlan === "Pro" && (
                  <span className="absolute top-2 right-2 bg-violet-600 dark:bg-violet-500 p-0.5 rounded-full text-white">
                    <Check size={10} />
                  </span>
                )}
                <div className="font-bold text-violet-700 dark:text-violet-450 flex items-center gap-1.5">
                  Pro Plan <span className="text-[9px] bg-violet-100 dark:bg-violet-950/40 text-violet-700 dark:text-violet-300 px-1.5 py-0.5 rounded-md font-semibold">Popular</span>
                </div>
                <div className="text-[11px] text-slate-400 dark:text-slate-500 mt-1">
